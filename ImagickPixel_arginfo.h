 ...
 * Stub hash: ae453335ccec9914ae0aa6ae920a62a6bd78f972 */
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_ImagickPixel_getColorValueQuantum, 0, 1, IMAGICK_QUANTUM_TYPE, 0)
	ZEND_ARG_TYPE_INFO(0, color, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ImagickPixel_setIndex, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, index, IMAGICK_QUANTUM_TYPE, 0)
ZEND_END_ARG_INFO()
