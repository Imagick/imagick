 ...
 * Stub hash: 6dc22e24940b1bbff934d0dc9034755150447ece */
...
#endif
#if MagickLibVersion > 0x628 && MagickLibVersion < 0x700
ZEND_METHOD(Imagick, roundCorners);
#endif
#if MagickLibVersion > 0x628
...
#endif
#if MagickLibVersion > 0x628 && MagickLibVersion < 0x700
	ZEND_ME(Imagick, roundCorners, arginfo_class_Imagick_roundCorners, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED)
#endif
#if MagickLibVersion > 0x628
