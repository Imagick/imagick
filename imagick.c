...
static void php_imagick_object_free_storage(IM_ZEND_OBJECT *object)
{
...
static void php_imagickdraw_object_free_storage(IM_ZEND_OBJECT *object)
{
...
static void php_imagickpixeliterator_object_free_storage(IM_ZEND_OBJECT *object)
{
...
static void php_imagickpixel_object_free_storage(IM_ZEND_OBJECT *object)
{
...
#ifdef IMAGICK_WITH_KERNEL
static void php_imagickkernel_object_free_storage(IM_ZEND_OBJECT *object)
{
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_object_new_ex(zend_class_entry *class_type, php_imagick_object **ptr, zend_bool init_wand)
#else
static zend_object_value php_imagick_object_new_ex(zend_class_entry *class_type, php_imagick_object **ptr, zend_bool init_wand)
#endif

{
	...
	return &intern->zo;
#else
	retval.handle = zend_objects_store_put(intern, NULL, (zend_objects_free_object_storage_t) php_imagick_object_free_storage, NULL);
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_object_new(zend_class_entry *class_type)
#else
static zend_object_value php_imagick_object_new(zend_class_entry *class_type)
#endif
{
	return php_imagick_object_new_ex(class_type, NULL, 1);
}

#ifdef ZEND_ENGINE_3
static zend_object * php_imagickdraw_object_new_ex(zend_class_entry *class_type, php_imagickdraw_object **ptr, zend_bool init_wand)
#else
static zend_object_value php_imagickdraw_object_new_ex(zend_class_entry *class_type, php_imagickdraw_object **ptr, zend_bool init_wand)
#endif
{
	...
	zend_object_std_init(&intern->zo, class_type);
	object_properties_init(&intern->zo, class_type);
	retval.handle = zend_objects_store_put(intern, NULL, (zend_objects_free_object_storage_t) php_imagickdraw_object_free_storage, NULL);
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagickdraw_object_new(zend_class_entry *class_type)
#else
static zend_object_value php_imagickdraw_object_new(zend_class_entry *class_type)
#endif
{
	return php_imagickdraw_object_new_ex(class_type, NULL, 1);
}

#ifdef ZEND_ENGINE_3
static zend_object * php_imagickpixeliterator_object_new(zend_class_entry *class_type)
#else
static zend_object_value php_imagickpixeliterator_object_new(zend_class_entry *class_type)
#endif
{
	...
	return &intern->zo;
#else
	retval.handle = zend_objects_store_put(intern, NULL, (zend_objects_free_object_storage_t) php_imagickpixeliterator_object_free_storage, NULL);
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagickpixel_object_new_ex(zend_class_entry *class_type, php_imagickpixel_object **ptr)
#else
static zend_object_value php_imagickpixel_object_new_ex(zend_class_entry *class_type, php_imagickpixel_object **ptr)
#endif
{
	...
	return &intern->zo;
#else
	retval.handle = zend_objects_store_put(intern, NULL, (zend_objects_free_object_storage_t) php_imagickpixel_object_free_storage, NULL);
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagickpixel_object_new(zend_class_entry *class_type)
#else
static zend_object_value php_imagickpixel_object_new(zend_class_entry *class_type)
#endif
{
	return php_imagickpixel_object_new_ex(class_type, NULL);
}

#ifdef IMAGICK_WITH_KERNEL

#ifdef ZEND_ENGINE_3
static zend_object *  php_imagickkernel_object_new_ex(zend_class_entry *class_type, php_imagickkernel_object **ptr)
#else
static zend_object_value php_imagickkernel_object_new_ex(zend_class_entry *class_type, php_imagickkernel_object **ptr)
#endif
{
	...
	return &intern->zo;
#else
	retval.handle = zend_objects_store_put(intern, NULL, (zend_objects_free_object_storage_t) php_imagickkernel_object_free_storage, NULL);
...
#ifdef IMAGICK_WITH_KERNEL
#ifdef ZEND_ENGINE_3
static zend_object * php_imagickkernel_object_new(zend_class_entry *class_type)
#else
static zend_object_value php_imagickkernel_object_new(zend_class_entry *class_type)
#endif
{
	return php_imagickkernel_object_new_ex(class_type, NULL);
}
#endif
...
static int php_imagick_count_elements(zval *object, im_long *count) /* {{{ */
{
...
#ifdef ZEND_ENGINE_3
static zval *php_imagick_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
	int ret;
	php_imagick_object *intern;
	zval *retval = NULL;
	...
	if (ret) {
		...
		//ZVAL_COPY_VALUE(retval, std_hnd->read_property(object, member, type, cache_slot, rv));
...
#if PHP_VERSION_ID < 50399
static zval *php_imagick_read_property(zval *object, zval *member, int type)
#else
static zval *php_imagick_read_property(zval *object, zval *member, int type, const zend_literal *key)
#endif
{
	int ret;
	php_imagick_object *intern;
	...
	std_hnd = zend_get_std_object_handlers();
#if PHP_VERSION_ID < 50399
	ret = std_hnd->has_property(object, member, 2);
#else
	ret = std_hnd->has_property(object, member, 2, key);
#endif
	...
	if (ret) {
		...
		intern = (php_imagick_object *) zend_object_store_get_object(object);
		/* Do we have any images? */
		if (MagickGetNumberImages(intern->magick_wand)) {
			/* Is this overloaded? */
			if (!strcmp(Z_STRVAL_P(member), "width") ||
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_clone_imagick_object(zval *this_ptr)
#else
static zend_object_value php_imagick_clone_imagick_object(zval *this_ptr)
#endif
{
	...
	zend_object * new_zo = php_imagick_object_new_ex(old_obj->zo.ce, &new_obj, 0);
	zend_objects_clone_members(&new_obj->zo, &old_obj->zo);
#else
	php_imagick_object *old_obj = (php_imagick_object *) zend_object_store_get_object(this_ptr);
	zend_object_value new_zo = php_imagick_object_new_ex(old_obj->zo.ce, &new_obj, 0);
	zend_objects_clone_members(&new_obj->zo, new_zo, &old_obj->zo, Z_OBJ_HANDLE_P(this_ptr));
#endif
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_clone_imagickdraw_object(zval *this_ptr)
#else
static zend_object_value php_imagick_clone_imagickdraw_object(zval *this_ptr)
#endif
{
	...
	zend_object * new_zo = php_imagickdraw_object_new_ex(old_obj->zo.ce, &new_obj, 0);
	zend_objects_clone_members(&new_obj->zo, &old_obj->zo);
#else
	php_imagickdraw_object *old_obj = (php_imagickdraw_object *) zend_object_store_get_object(this_ptr);
	zend_object_value new_zo = php_imagickdraw_object_new_ex(old_obj->zo.ce, &new_obj, 0);
	zend_objects_clone_members(&new_obj->zo, new_zo, &old_obj->zo, Z_OBJ_HANDLE_P(this_ptr));
#endif
...
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_clone_imagickpixel_object(zval *this_ptr)
#else
static zend_object_value php_imagick_clone_imagickpixel_object(zval *this_ptr)
#endif
{
	...
	new_zo = php_imagickpixel_object_new_ex(old_obj->zo.ce, &new_obj);
	zend_objects_clone_members(&new_obj->zo, &old_obj->zo);
#else
	php_imagickpixel_object *old_obj = (php_imagickpixel_object *) zend_object_store_get_object(this_ptr);
	zend_object_value new_zo = php_imagickpixel_object_new_ex(old_obj->zo.ce, &new_obj);
	zend_objects_clone_members(&new_obj->zo, new_zo, &old_obj->zo, Z_OBJ_HANDLE_P(this_ptr));
#endif
...
#ifdef IMAGICK_WITH_KERNEL
#ifdef ZEND_ENGINE_3
static zend_object * php_imagick_clone_imagickkernel_object(zval *this_ptr)
#else
static zend_object_value php_imagick_clone_imagickkernel_object(zval *this_ptr)
#endif
{
	...
	new_zo = php_imagickkernel_object_new_ex(old_obj->zo.ce, &new_obj);
	zend_objects_clone_members(&new_obj->zo, &old_obj->zo);
#else
	zend_object_value new_zo;
	php_imagickkernel_object *old_obj = (php_imagickkernel_object *) zend_object_store_get_object(this_ptr);
	new_zo = php_imagickkernel_object_new_ex(old_obj->zo.ce, &new_obj);
	zend_objects_clone_members(&new_obj->zo, new_zo, &old_obj->zo, Z_OBJ_HANDLE_P(this_ptr));
#endif
...
PHP_MINIT_FUNCTION(imagick)
{
	...
	*/
	...
	php_imagick_sc_entry = zend_register_internal_class(&ce);
#if defined(HAVE_SPL)
	zend_class_implements(php_imagick_sc_entry, 2, zend_ce_iterator, spl_ce_Countable);
#else
	zend_class_implements(php_imagick_sc_entry, 1, zend_ce_iterator);
#endif
...
#endif
	php_imagickdraw_sc_entry = zend_register_internal_class(&ce);
...
#endif
	php_imagickpixeliterator_sc_entry = zend_register_internal_class(&ce);
	zend_class_implements(php_imagickpixeliterator_sc_entry, 1, zend_ce_iterator);
	...
	*/
	...
	php_imagickpixel_sc_entry = zend_register_internal_class(&ce);
...
PHP_RSHUTDOWN_FUNCTION(imagick)
{
	...
	if (progress_callback) {
		php_imagick_cleanup_progress_callback(progress_callback);
