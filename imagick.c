...
PHP_METHOD(imagick, getimagemagicklicense)
{
	...
	char *license = "MS4gRGVmaW5pdGlvbnMuCgpMaWNlbnNlIHNoYWxsIG1lYW4gdGhlIHRlcm1zIGFuZCBjb25kaXRpb25zIG" \
	 ...
	 result = (unsigned char *)php_base64_decode( license, strlen( license ), &ret_len ); 	 
