...
#endif
#if MagickLibVersion >= 0x665
	IMAGICK_REGISTER_CONST_LONG("FILTER_JINC", JincFilter);
	IMAGICK_REGISTER_CONST_LONG("FILTER_SINCFAST", SincFastFilter);
	IMAGICK_REGISTER_CONST_LONG("FILTER_LANCZOS2D", Lanczos2DFilter);
	IMAGICK_REGISTER_CONST_LONG("FILTER_LANCZOS2DSHARP", Lanczos2DSharpFilter);
